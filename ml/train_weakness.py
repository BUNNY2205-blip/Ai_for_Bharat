"""Train academic weakness classifier for MindLearn AI."""
...
TEST_SIZE = 0.2
CV_FOLDS = 5
FEATURES = ["accuracy", "attempts", "avg_time", "difficulty", "repeated_errors"]
TARGET = "label"
DATA_PATH = Path(__file__).resolve().parent.parent / "dataset" / "academic_data.csv"
MODEL_DIR = Path(__file__).resolve().parent.parent / "model"
MODEL_PATH = MODEL_DIR / "weakness_model.pkl"
LABEL_NAMES = {0: "Strong", 1: "Moderate", 2: "Weak"}
...
def train() -> None:
    """Train, evaluate, and persist academic weakness model pipeline."""
    ...
    print("\nAcademic Weakness Classification Report:")
    print(
